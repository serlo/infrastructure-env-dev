...
module "kpi" {
  source = "github.com/serlo/infrastructure-modules-kpi.git//kpi?ref=v2.0.0"
...
module "kpi_metrics" {
  source = "github.com/serlo/infrastructure-modules-kpi.git//kpi_metrics?ref=v2.0.0"
}

module "kpi_ingress" {
  source = "github.com/serlo/infrastructure-modules-shared.git//ingress?ref=v1.0.0"
